...
public class ExcelUtils {  
     ...
     * @throws IOException 
     */  
    public List<Row> readExcelIs() throws IOException{  
        return readExcelIs(this.is);  
    }  
     ...
     * @throws IOException 
     */  
    public static List<Row> readExcelIs(InputStream is) throws IOException{  
          
        try {  
              
            return readExcel_xlsIs(is);
        } catch (IOException e) {  
            throw e;  
        }  
    }
     ...
     * @throws IOException
     */
    public static List<Row> readExcelIs(InputStream is,String fileName) throws IOException{  
          
        try {  
            List<Row> rows = new ArrayList<>();
            if(isExcel2003(fileName)) {
                rows = readExcel_xlsIs(is);
            }
            if(isExcel2007(fileName)) {
                rows = readExcel_xlsxIs(is);
            }
    ...
    public static List<Row> readExcel_xlsxIs(InputStream is) throws IOException {  
    ...
    public static List<Row> readExcel_xlsIs(InputStream is) throws IOException {  
    ...
    public static boolean writerExcel(String[] title,List<Object[]> dataList, OutputStream os)
    {
        boolean b = true;
        int exportSize = 65536;
	...
	public static boolean isExcel2003(String fileName){
        return fileName.toLowerCase().matches(".*(.xls)$");
    }
	
	public static boolean isExcel2007(String fileName){
        return fileName.toLowerCase().matches(".*(.xlsx)$");
    }
